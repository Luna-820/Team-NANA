$(function () {
  ...
  const teacherData = {
    tetsu: {
      img: `${wp_options.template_dir}/img/teacher_pic_tetsu.png`,
      position: '現役エンジニア講師',
      name: 'TETSU',
    ...
    yuriko: {
      img: `${wp_options.template_dir}/img/teacher_pic_yuriko.png`,
      position: '現役エンジニア講師',
      name: 'YURIKO',
    ...
    miya: {
      img: `${wp_options.template_dir}/img/teacher_pic_miya.png`,
      position: '現役エンジニア講師',
      name: 'MIYAGUCHI',
    ...
    atsuko: {
      img: `${wp_options.template_dir}/img/teacher_pic_atsuko.png`,
      position: '現役エンジニア講師',
      name: 'ATSUKO',
